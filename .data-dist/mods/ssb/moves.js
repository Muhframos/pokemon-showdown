	...
	*/
	...
	cozycuddle: {
		...
		condition: {
			...
			onTrapPokemon(pokemon) {
				if (_optionalChain([this, 'access', _11 => _11.effectData, 'access', _12 => _12.source, 'optionalAccess', _13 => _13.isActive])) pokemon.tryTrap();
			},
		},
		secondary: null,
		target: "normal",
	...
	trickery: {
		...
		onHit(target, source, effect) {
			this.add(`c|${_conditions.getName.call(void 0, 'Perish Song')}|/html <img src="https://i.imgflip.com/3rt1d8.png" />`);
			const item = target.takeItem(source);
			if (!target.item) {
