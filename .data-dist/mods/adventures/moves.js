...
//Move changes
	...
	vinetrap: {
		...
		onModifyMove(move, source, target) {
			if (_optionalChain([target, 'optionalAccess', _6 => _6.beingCalledBack]) || _optionalChain([target, 'optionalAccess', _7 => _7.switchFlag])) move.accuracy = true;
		},
	...
	gravity: {
		...
		condition: {
			duration: 5,
			durationCallback(source, effect) {
				if (_optionalChain([source, 'optionalAccess', _8 => _8.hasItem, 'call', _9 => _9('unidentifiedforeignrock')])) {
				return 8;
				}	
				if (_optionalChain([source, 'optionalAccess', _10 => _10.hasAbility, 'call', _11 => _11('persistent')])) {
